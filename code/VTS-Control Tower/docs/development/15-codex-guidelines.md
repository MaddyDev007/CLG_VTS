...
- `docs/contracts/03-messaging-spec.md`
- `docs/contracts/04-backend-contracts.md`
- `docs/contracts/05-frontend-contracts.md`
- `docs/architecture/08-data-model.md`
- `docs/architecture/09-event-processing.md`
