...
- `vts-device-simulator`: backend-oriented simulator that publishes MQTT telemetry for assigned devices
- `simulator`: UI-driven telemetry publisher for manual and game-style simulation
